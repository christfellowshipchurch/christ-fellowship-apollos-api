...
const resolver = {
  ...
  Query: {
    ...
    pageBuilderFeatures: async (root, { url }, { dataSources: { Feature } }) =>
      Feature.getPageBuilderFeatures(url),
    userFeedFeatures: async (root, args, { clientVersion, dataSources: { Feature } }) => {
      ...
      return clientVersion &&
        (clientVersion.startsWith('5.0') ||
          clientVersion.startsWith('5.1') ||
          clientVersion.startsWith('web-1.'))
